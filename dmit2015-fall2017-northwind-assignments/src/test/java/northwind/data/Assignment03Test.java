...
//		List<EmployeeSalesForYear> queryResults = employeeRepository.findEmployeeSalesForYear(1997);
//		assertEquals(9, queryResults.size());
//		
//		// verify all results
//		EmployeeSalesForYear result1 = queryResults.get(0);
//		assertEquals("Margaret Peacock", result1.getEmployeeName());
//		assertEquals(124655.57, result1.getEmployeeSales().doubleValue(), 0);
//		
//		EmployeeSalesForYear result2 = queryResults.get(1);
//		assertEquals("Janet Leverling", result2.getEmployeeName());
//		assertEquals(103719.09, result2.getEmployeeSales().doubleValue(), 0);
//		
//		EmployeeSalesForYear result3 = queryResults.get(2);
//		assertEquals("Nancy Davolio", result3.getEmployeeName());
//		assertEquals(95850.39, result3.getEmployeeSales().doubleValue(), 0);
//		
//		EmployeeSalesForYear result4 = queryResults.get(3);
//		assertEquals("Andrew Fuller", result4.getEmployeeName());
//		assertEquals(71168.14, result4.getEmployeeSales().doubleValue(), 0);
//		
//		EmployeeSalesForYear result5 = queryResults.get(4);
//		assertEquals("Robert King", result5.getEmployeeName());
//		assertEquals(59827.20, result5.getEmployeeSales().doubleValue(), 0);
//		
//		EmployeeSalesForYear result6 = queryResults.get(5);
//		assertEquals("Laura Callahan", result6.getEmployeeName());
//		assertEquals(56954.04, result6.getEmployeeSales().doubleValue(), 0);
//		
//		EmployeeSalesForYear result7 = queryResults.get(6);
//		assertEquals("Michael Suyama", result7.getEmployeeName());
//		assertEquals(40826.37, result7.getEmployeeSales().doubleValue(), 0);
//		
//		EmployeeSalesForYear result8 = queryResults.get(7);
//		assertEquals("Steven Buchanan", result8.getEmployeeName());
//		assertEquals(31433.19, result8.getEmployeeSales().doubleValue(), 0);
//
//		EmployeeSalesForYear result9 = queryResults.get(8);
//		assertEquals("Anne Dodsworth", result9.getEmployeeName());
//		assertEquals(24412.89, result9.getEmployeeSales().doubleValue(), 0);
//				
//	}
//	
//	@Test
